...
//	: Engine(hInstance)
//{
//	mMainWndCaption = "Animated Mesh Demo";
...
//	mPosition.x = 5.0f; mPosition.y = 5.0f; mPosition.z = 25.0f;
//	mBillboard->mPosition = mPosition;
//
//	mParticleEmitter = new DPhoenix::ParticleEmitter();
//	mParticleEmitter->Load("Textures\\ObjectAssets\\KnowledgeFire.png", &mTexMgr, 1.0f, 1.0f, md3dDevice);
//	mParticleEmitter->mSprite->SetCurrentFrame(0);	mParticleEmitter->mSprite->mAnimationColumns = 8;
//	mParticleEmitter->mSprite->mAnimationDirection = 16;	mParticleEmitter->mSprite->SetAnimationRange(0, 7);
//	mParticleEmitter->mSprite->SetScale(1.0f);	mParticleEmitter->mSprite->mFlipValue = 1.0f;
//
...
//	mAnimInstance->mPosition = XMFLOAT3(-200.0f, 50.0f, -200.0f);
//	mAnimInstance->mPrevPosition = XMFLOAT3(-200.0f, 50.0f, -200.0f);
//	mAnimInstance->mScale = XMFLOAT3(5.0f, 5.0f, 5.0f);
//
...
//
//	//are we within 1 unit of the waypoint?
//	if (std::abs(xDistance) < 1.0f &&
//		std::abs(yDistance) < 1.0f &&
//		std::abs(zDistance) < 1.0f)
//	{
//		//if so go to next waypoint (wrap to 0)
...
//	XMStoreFloat3(&facingDir, facingVec);
//
//	//set the forward vector for the model and update velocity forwards
//	//relative movement based on facing direction
...
//	mAnimInstance->mRelativeVelocity = XMFLOAT3(0.0f, 0.0f, 20.0f);
...
//	md3dImmediateContext->IASetInputLayout(DPhoenix::InputLayouts::PosNormalTexTan);
//
//	//RenderBasicModelNormal(mBasicInstance, activeLitTexNormalTech);
//
...
//}
//
//void AnimatedMeshDemo::RenderColorPrimitive(DPhoenix::PrimitiveInstance * model,
//	ID3DX11EffectTechnique * tech)
//{
//	//here we calculate the scale on X and Y based on the client width / height
//	//vs. our original resolution 
...
//}
//
//void AnimatedMeshDemo::RenderBillboardSprite(DPhoenix::BillboardSprite * sprite,
//	ID3DX11EffectTechnique * tech)
//{
//	//create view / projection matrix
//	XMMATRIX view = mCamera->GetView();
