...
class BTLTMap : public DPhoenix::Engine
{
private:
...
public:
	...
	void BTLTMap::HandleEvents(DPhoenix::IEvent* e);
	...
	void BTLTMap::RenderBasicTexPrimitive(DPhoenix::PrimitiveInstance* model,
		ID3DX11EffectTechnique* tech);

	//new method / specifically handles textured primitives with directional lights
	//and fog
	void BTLTMap::RenderLitTexPrimitive(DPhoenix::PrimitiveInstance* model,
		ID3DX11EffectTechnique* tech);

	//new method / now with normal mapping!
	void BTLTMap::RenderLitTexNormPrimitive(DPhoenix::PrimitiveInstance* model,
		ID3DX11EffectTechnique* tech);
	...
	void BTLTMap::RenderBillboardSprite(DPhoenix::BillboardSprite* model,
		ID3DX11EffectTechnique* tech);

	//new method / render static mesh with subsets
	void BTLTMap::RenderBasicModel(DPhoenix::BasicModelInstance* model,
		ID3DX11EffectTechnique* tech);

	//new method / render static mesh with subsets
	void BTLTMap::RenderBasicModelNormal(DPhoenix::BasicModelInstance* model,
		ID3DX11EffectTechnique* tech);

	//new method / render animated lit mesh with subsets
	void BTLTMap::RenderSkinnedModel(DPhoenix::SkinnedModelInstance* model,
		ID3DX11EffectTechnique* tech);

	//new method / render animated lit normal mapped mesh with subsets
	void BTLTMap::RenderSkinnedModelNormal(DPhoenix::SkinnedModelInstance* model,
		ID3DX11EffectTechnique* tech);

#pragma region BTLTMethods

	bool BTLTMap::CheckPointInRect(int pointX, int pointY, RECT rect);
	void BTLTMap::CheckMouseHoverMenu();
	void BTLTMap::CheckMouseClickMenu();
...
BTLTMap::BTLTMap(HINSTANCE hInstance)
	: Engine(hInstance)
{
...
bool BTLTMap::Init(bool fullScreen)
{
...
#pragma region BTLTInit
	...
	//these are initial loads of the character classes for the purpose of display on the menu screen
	//positions, rotations etc. were figured out via experimentation
	...
	mToySoldierMenu->mModelInstance->mPosition.y = -7.5f;
	mToySoldierMenu->mModelInstance->mPosition.z = 37.5f;
	mToySoldierMenu->mModelInstance->mScale = XMFLOAT3(3.5f, 3.5f, 3.5f);
	mToySoldierMenu->mModelInstance->mRotYOffset = -90.0f;

	mDarkAngelMenu = new DPhoenix::CharacterClass(DPhoenix::DARK_ANGEL_CLASS,
		&mTexMgr, md3dDevice, &mAudioMgr);
	mDarkAngelMenu->mModelInstance->mPosition.x = 50.0f;
	mDarkAngelMenu->mModelInstance->mPosition.y = -7.5f;
	mDarkAngelMenu->mModelInstance->mPosition.z = mToySoldierMenu->mModelInstance->mPosition.z - 12.5f;
	mDarkAngelMenu->mModelInstance->mScale = XMFLOAT3(10.0f, 10.0f, 10.0f);
	mDarkAngelMenu->mModelInstance->mRotYOffset = -90.0f;

	mDragonMenu = new DPhoenix::CharacterClass(DPhoenix::DRAGON_CLASS,
		&mTexMgr, md3dDevice, &mAudioMgr);
	mDragonMenu->mModelInstance->mPosition.x = 50.0f;
	mDragonMenu->mModelInstance->mPosition.y = -7.5f;
	mDragonMenu->mModelInstance->mPosition.z = mDarkAngelMenu->mModelInstance->mPosition.z - 12.5f;
	mDragonMenu->mModelInstance->mScale = XMFLOAT3(10.0f, 10.0f, 10.0f);
	mDragonMenu->mModelInstance->mRotYOffset = -90.0f;

	mBigCatMenu = new DPhoenix::CharacterClass(DPhoenix::BIG_CAT_CLASS,
		&mTexMgr, md3dDevice, &mAudioMgr);
	mBigCatMenu->mModelInstance->mPosition.x = 50.0f;
	mBigCatMenu->mModelInstance->mPosition.y = -7.5f;
	mBigCatMenu->mModelInstance->mPosition.z = mDragonMenu->mModelInstance->mPosition.z - 12.5f;
	mBigCatMenu->mModelInstance->mScale = XMFLOAT3(6.0f, 6.0f, 6.0f);
	mBigCatMenu->mModelInstance->mRotYOffset = -90.0f;

	mSelectedLevel = 1;

	//Initial animations --------------------------------------------------------------------------------
	mToySoldierMenu->mAnimModel->Animator->SetAnimation(DPhoenix::IDLE_ANIMATION);
	mDarkAngelMenu->mAnimModel->Animator->SetAnimation(DPhoenix::IDLE_ANIMATION);
	mDragonMenu->mAnimModel->Animator->SetAnimation(DPhoenix::IDLE_ANIMATION);
	mBigCatMenu->mAnimModel->Animator->SetAnimation(DPhoenix::IDLE_ANIMATION);
...
#pragma region BTLTMapInit
	...
	mFloorColorMaps.insert(mFloorColorMaps.end(),
		{"Textures\\Floor\\Floor_B_cm.png", "Textures\\Floor\\Floor_C_cm.png", "Textures\\Floor\\Floor_D_cm.png", "Textures\\Floor\\Floor_F_cm.png",
		"Textures\\Floor\\Floor_F_cm.png", "Textures\\Floor\\Floor_G_cm.png", "Textures\\Floor\\Floor_H_cm.png", "Textures\\Floor\\Floor_J_cm.png",
		"Textures\\Floor\\Floor_K_cm.png", "Textures\\Floor\\Floor_L_cm.png", "Textures\\Floor\\Floor_M_cm.png", "Textures\\Floor\\Floor_P_cm.png",
		"Textures\\Floor\\Floor_Q_cm.png", "Textures\\Floor\\Floor_R_cm.png", "Textures\\Floor\\Floor_S_cm.png", "Textures\\Floor\\Floor_T_cm.png",
		"Textures\\Floor\\Floor_V_cm.png", "Textures\\Floor\\Floor_W_cm.png", "Textures\\Floor\\Floor_X_cm.png", "Textures\\Floor\\Floor_Y_cm.png",
		"Textures\\Floor\\Floor_Z_cm.png" });

	mFloorNormalMaps.insert(mFloorNormalMaps.end(),
		{"Textures\\Floor\\Floor_B_nm.png", "Textures\\Floor\\Floor_C_nm.png", "Textures\\Floor\\Floor_D_nm.png", "Textures\\Floor\\Floor_F_nm.png",
		"Textures\\Floor\\Floor_F_nm.png", "Textures\\Floor\\Floor_G_nm.png", "Textures\\Floor\\Floor_H_nm.png", "Textures\\Floor\\Floor_J_nm.png",
		"Textures\\Floor\\Floor_K_nm.png", "Textures\\Floor\\Floor_L_nm.png", "Textures\\Floor\\Floor_M_nm.png", "Textures\\Floor\\Floor_P_nm.png",
		"Textures\\Floor\\Floor_Q_nm.png", "Textures\\Floor\\Floor_R_nm.png", "Textures\\Floor\\Floor_S_nm.png", "Textures\\Floor\\Floor_T_nm.png",
		"Textures\\Floor\\Floor_V_nm.png", "Textures\\Floor\\Floor_W_nm.png", "Textures\\Floor\\Floor_X_nm.png", "Textures\\Floor\\Floor_Y_nm.png",
		"Textures\\Floor\\Floor_Z_nm.png" });

	mWallColorMaps.insert(mWallColorMaps.end(),
		{"Textures\\Wall\\Wall_A_cm.png", "Textures\\Wall\\Wall_E_cm.png", "Textures\\Wall\\Wall_I_cm.png", "Textures\\Wall\\Wall_O_cm.png", "Textures\\Wall\\Wall_U.cm.png"	});

	mWallNormalMaps.insert(mWallNormalMaps.end(),
		{"Textures\\Wall\\Wall_A_nm.png", "Textures\\Wall\\Wall_E_nm.png", "Textures\\Wall\\Wall_I_nm.png", "Textures\\Wall\\Wall_O_nm.png", "Textures\\Wall\\Wall_U.nm.png" });

	mCoverColorMaps.insert(mCoverColorMaps.end(),
		{"Textures\\Cover\\Cover_DeanyP_cm.png", "Textures\\Cover\\Cover_Humpty_cm.png", "Textures\\Cover\\Cover_Ninja_cm.png", "Textures\\Cover\\Cover_SS_cm.png"	});
	
	mCoverNormalMaps.insert(mCoverNormalMaps.end(), 
		{ "Textures\\Cover\\Cover_DeanyP_nm.png", "Textures\\Cover\\Cover_Humpty_nm.png", "Textures\\Cover\\Cover_Ninja_nm.png", "Textures\\Cover\\Cover_SS_nm.png" });


	/*mMap = new DPhoenix::BTLTMap("Data\\Levels\\Level1.csv", &mTexMgr, md3dDevice, mEnable4xMsaa, mPlayerSpawnVec, mBeaconSpawnVec, &mBox, mFloorColorMaps, mFloorNormalMaps,
	...
	mMap = new DPhoenix::BTLTMap("Data\\Levels\\Level1.csv", &mTexMgr, md3dDevice,
		...
		mCoverColorMaps, mCoverNormalMaps, 30, 30, 20.f);
...
//here we give a point location and see if it is in the given rectangle
bool BTLTMap::CheckPointInRect(int pointX, int pointY, RECT rect)
{
	if (pointX < rect.left)
		return false;
...
//check for where we are ghovering for selection display
void BTLTMap::CheckMouseHoverMenu()
{
	...
	//here we check each of the class selection areas based on the constants identified
	//we will change the position of the hover image and opacity based on this
	if (CheckPointInRect(mouseX, mouseY, BTLTConst::selectToySoldier))
	{
		mSelectedClassMenu->mPosition.x = BTLTConst::selectToySoldier.left + BTLTConst::selectHoverImageWidth / 2;
		mSelectedClassMenu->mPosition.y = BTLTConst::selectToySoldier.top - BTLTConst::selectHoverImageHeight / 2;
		mSelectedClassMenu->mOpacityValue = 1.0f;
	}
	else if (CheckPointInRect(mouseX, mouseY, BTLTConst::selectDarkAngel))
	{
		mSelectedClassMenu->mPosition.x = BTLTConst::selectDarkAngel.left + BTLTConst::selectHoverImageWidth / 2;
		mSelectedClassMenu->mPosition.y = BTLTConst::selectDarkAngel.top - BTLTConst::selectHoverImageHeight / 2;
		mSelectedClassMenu->mOpacityValue = 1.0f;
	}
	else if (CheckPointInRect(mouseX, mouseY, BTLTConst::selectDragon))
	{
		mSelectedClassMenu->mPosition.x = BTLTConst::selectDragon.left + BTLTConst::selectHoverImageWidth / 2;
		mSelectedClassMenu->mPosition.y = BTLTConst::selectDragon.top - BTLTConst::selectHoverImageHeight / 2;
		mSelectedClassMenu->mOpacityValue = 1.0f;
	}
	else if (CheckPointInRect(mouseX, mouseY, BTLTConst::selectBigCat))
	{
		mSelectedClassMenu->mPosition.x = BTLTConst::selectBigCat.left + BTLTConst::selectHoverImageWidth / 2;
		mSelectedClassMenu->mPosition.y = BTLTConst::selectBigCat.top - BTLTConst::selectHoverImageHeight / 2;
		mSelectedClassMenu->mOpacityValue = 1.0f;
	}
	else
	{
...
void BTLTMap::CheckMouseClickMenu()
{
	...
	//arrows and icons
	else if (CheckPointInRect(mouseX, mouseY, BTLTConst::selectUpArrow))
	{
		//change and bound level value - recalculate all stats
	...
	else if (CheckPointInRect(mouseX, mouseY, BTLTConst::selectDownArrow))
	{
		//change and bound level value - recalculate all stats
		if (mSelectedLevel > 1)
		{
	...
	else if (CheckPointInRect(mouseX, mouseY, BTLTConst::selectRemoveLast))
	{
		//'pop' / remove last entry in player team members
...
void BTLTMap::UpdateScene(float dt)
{
	...
	case GAME_MENU_STATE:
		...
		mToySoldierMenu->mModelInstance->Update(dt, true);
		mDarkAngelMenu->mModelInstance->Update(dt, true);
		mDragonMenu->mModelInstance->Update(dt, true);
		mBigCatMenu->mModelInstance->Update(dt, true);
		...
		case ENEMY_4_PICKED_MENUSTATE:
			...
			if (mWaitTimer.TotalTime() > 2.0f)
			{
				...
				mBigCatMenu->mModelInstance->mRotYOffset = XMConvertToRadians(90.0f);
	...
	case GAME_PLAY_STATE:
		...
		//unit circle calculations for radius around player to pos camera
...
void BTLTMap::BuildGeometryBuffers()
{
...
#pragma region RenderSkinnedNormalMeshes
	...
	{
	case GAME_MENU_STATE:
		RenderSkinnedModelNormal(mToySoldierMenu->mModelInstance, activeLitTexNormSkinnedTech);
		RenderSkinnedModelNormal(mDarkAngelMenu->mModelInstance, activeLitTexNormSkinnedTech);
		RenderSkinnedModelNormal(mDragonMenu->mModelInstance, activeLitTexNormSkinnedTech);
		RenderSkinnedModelNormal(mBigCatMenu->mModelInstance, activeLitTexNormSkinnedTech);
		break;
	case GAME_PLAY_STATE:
		// loop through each team to render em
		for (int i = 0; i < mPlayerTeam->mTeamMembers.size(); i++)
		{
...
#pragma region RenderFonts
	...
	case GAME_MENU_STATE:
		...
		mUIFont90pt->DrawFont(m2D1RT, leveltext.str(), BTLTConst::selectedLevelLeft,
			BTLTConst::selectedLevelTop,
...
#pragma region SelectedClasses
		...
		//loop through selected classes and adjust row position with each
		float rowAdjust = 0.0f;

		for (int i = 0; i < mPlayerTeam->mTeamMembers.size();
			i++, rowAdjust += BTLTConst::selectedCharacterClassesRowSpacing)
		{
			...
			mUIFont36pt->DrawFont(m2D1RT, classesText.str(), BTLTConst::selectedCharacterClassesLeft,
				BTLTConst::selectedCharacterClassesTop + rowAdjust,
				1.0f, 1.0f, D2D1::ColorF(0xFFFFFF, 1.0f));
		...
		for (int i = 0; i < mEnemyTeam->mTeamMembers.size();
			i++, rowAdjust += BTLTConst::selectedEnemyClassesRowSpacing)
		{
			...
			//call draw font method sending all key info
			//thankfully, fonts are from top-left (but drawn from the bottom!!!!)
			mUIFont36pt->DrawFont(m2D1RT, classesText.str(), BTLTConst::selectedEnemyClassesLeft,
				BTLTConst::selectedEnemyClassesTop + rowAdjust,
				1.0f, 1.0f, D2D1::ColorF(0xFFFFFF, 1.0f));
...
#pragma region ToySoldierStats
		...
		mUIFont16pt->DrawFont(m2D1RT, tsText.str(), BTLTConst::selectedToySoldierStatsLeft,
			BTLTConst::selectedToySoldierStatsTop,
			1.0f, 1.0f, D2D1::ColorF(0xFFFFFF, 1.0f));
...
#pragma region DarkAngelStats
		...
		//call draw font method sending all key info
		//thankfully, fonts are from top-left
		mUIFont16pt->DrawFont(m2D1RT, daText.str(), BTLTConst::selectedDarkAngelStatsLeft,
			BTLTConst::selectedDarkAngelStatsTop,
			1.0f, 1.0f, D2D1::ColorF(0xFFFFFF, 1.0f));
...
#pragma region DragonStats
		...
		//call draw font method sending all key info
		//thankfully, fonts are from top-left
		mUIFont16pt->DrawFont(m2D1RT, dText.str(), BTLTConst::selectedDragonStatsLeft,
			BTLTConst::selectedDragonStatsTop,
			1.0f, 1.0f, D2D1::ColorF(0xFFFFFF, 1.0f));
...
#pragma region BigCatStats
		...
		//call draw font method sending all key info
		//thankfully, fonts are from top-left
		mUIFont16pt->DrawFont(m2D1RT, bcText.str(), BTLTConst::selectedBigCatStatsLeft,
			BTLTConst::selectedBigCatStatsTop,
			1.0f, 1.0f, D2D1::ColorF(0xFFFFFF, 1.0f));
...
void BTLTMap::HandleEvents(DPhoenix::IEvent* e)
{
	...
	case DPhoenix::EVENT_MOUSEWHEEL:
	{
		...
		{
		case GAME_PLAY_STATE:
			mCameraDistanceOffset -= mwe->mWheel * 1.0f;
...
void BTLTMap::InitAudio()
{

}

void BTLTMap::RenderSprite(DPhoenix::Sprite* sprite, ID3DX11EffectTechnique* tech, bool isHUD)
{
...
void BTLTMap::RenderColorPrimitive(DPhoenix::PrimitiveInstance* model,
	ID3DX11EffectTechnique* tech)
{
	//here we calculate the scale on X and Y based on the client width / height
	//vs. our original resolution 
...
void BTLTMap::RenderSkybox(DPhoenix::Sky* skybox,
	ID3D11DeviceContext* dc)
{
	skybox->Draw(dc, mCamera);
}

void BTLTMap::RenderBillboardSprite(DPhoenix::BillboardSprite* sprite,
	ID3DX11EffectTechnique* tech)
{
	//create view / projection matrix
	XMMATRIX view = mCamera->GetView();
