...
void DPhoenix::MeshGeometry::Draw(ID3D11DeviceContext* dc, UINT subsetId)
{
	...
	//draw the subset based on the index values for this subset
	dc->DrawIndexed(
