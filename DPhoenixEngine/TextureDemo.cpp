...
//	mColorBoxes.back()->LoadBasicTexInstance(md3dDevice, "Textures\\Boxes\\dpnew.jpg",
//		mBox, &mTexMgr);
...
//
//	//camera updating - send 'look' direction
//	//converted from EAngle
...
//}
//
//void TextureDemo::RenderColorPrimitive(DPhoenix::PrimitiveInstance * model,
//	ID3DX11EffectTechnique * tech)
//{
//	//here we calculate the scale on X and Y based on the client width / height
//	//vs. our original resolution 
