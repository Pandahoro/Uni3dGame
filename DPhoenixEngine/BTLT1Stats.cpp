...
class BTLTStats : public DPhoenix::Engine
{
private:
...
public:
	...
	void BTLTStats::HandleEvents(DPhoenix::IEvent* e);
	...
	void BTLTStats::RenderBasicTexPrimitive(DPhoenix::PrimitiveInstance * model,
		ID3DX11EffectTechnique * tech);

	//new method / specifically handles textured primitives with directional lights
	//and fog
	void BTLTStats::RenderLitTexPrimitive(DPhoenix::PrimitiveInstance * model,
		ID3DX11EffectTechnique * tech);

	//new method / now with normal mapping!
	void BTLTStats::RenderLitTexNormPrimitive(DPhoenix::PrimitiveInstance * model,
		ID3DX11EffectTechnique * tech);
	...
	void BTLTStats::RenderBillboardSprite(DPhoenix::BillboardSprite * model,
		ID3DX11EffectTechnique * tech);

	//new method / render static mesh with subsets
	void BTLTStats::RenderBasicModel(DPhoenix::BasicModelInstance * model,
		ID3DX11EffectTechnique * tech);

	//new method / render static mesh with subsets
	void BTLTStats::RenderBasicModelNormal(DPhoenix::BasicModelInstance * model,
		ID3DX11EffectTechnique * tech);

	//new method / render animated lit mesh with subsets
	void BTLTStats::RenderSkinnedModel(DPhoenix::SkinnedModelInstance * model,
		ID3DX11EffectTechnique * tech);

	//new method / render animated lit normal mapped mesh with subsets
	void BTLTStats::RenderSkinnedModelNormal(DPhoenix::SkinnedModelInstance * model,
		ID3DX11EffectTechnique * tech);

#pragma region BTLTMethods

	bool BTLTStats::CheckPointInRect(int pointX, int pointY, RECT rect);
	void BTLTStats::CheckMouseHoverMenu();
	void BTLTStats::CheckMouseClickMenu();
...
BTLTStats::BTLTStats(HINSTANCE hInstance)
	: Engine(hInstance)
{
...
bool BTLTStats::Init(bool fullScreen)
{
...
#pragma region BTLTInit
	...
	mToySoldierMenu->mModelInstance->mRotation.y = XMConvertToRadians(90.0f);
	...
	mDarkAngelMenu->mModelInstance->mRotation.y = XMConvertToRadians(90.0f);
	...
	mDragonMenu->mModelInstance->mRotation.y = XMConvertToRadians(90.0f);
	...
	mBigCatMenu->mModelInstance->mRotation.y = XMConvertToRadians(90.0f);
...
void BTLTStats::UpdateScene(float dt)
{
...
void BTLTStats::BuildGeometryBuffers()
{
...
void BTLTStats::InitAudio()
{

}

void BTLTStats::RenderSprite(DPhoenix::Sprite * sprite, ID3DX11EffectTechnique * tech, bool isHUD)
{
...
void BTLTStats::RenderColorPrimitive(DPhoenix::PrimitiveInstance * model,
	ID3DX11EffectTechnique * tech)
{
	//here we calculate the scale on X and Y based on the client width / height
	//vs. our original resolution 
...
void BTLTStats::RenderSkybox(DPhoenix::Sky* skybox,
	ID3D11DeviceContext* dc)
{
	skybox->Draw(dc, mCamera);
}

void BTLTStats::RenderBillboardSprite(DPhoenix::BillboardSprite * sprite,
	ID3DX11EffectTechnique * tech)
{
	//create view / projection matrix
	XMMATRIX view = mCamera->GetView();
