...
//	mColorBox->LoadColorInstance(md3dDevice, XMFLOAT4(1.0f, 0.0f, 0.0f, 1.0f), mBox);
//
...
//}
//
//void ShapesDemo::RenderColorPrimitive(DPhoenix::PrimitiveInstance * model, 
//	ID3DX11EffectTechnique * tech)
//{
//	//here we calculate the scale on X and Y based on the client width / height
//	//vs. our original resolution 
...
//	//an identity matrix is standard and used as a basis
//	//for other calculations
//	//Build the view matrix (looking down the Z axis)
